...
«Образец»/«пример_верного_ответа» — лишь ОДИН из многих верных вариантов, а не эталон. НИКОГДА не называй ошибкой «не совпадает с образцом», «не соблюдено согласование с образцом», «в задании указано другое слово», «отличается от образца» и т.п.
