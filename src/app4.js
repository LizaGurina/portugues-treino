...
const PERIS = [
 ...
 {id:'adorar', rule:null, aux:['adoro','adoras','adora','adoramos','adoram'],
  ru:['Я обожаю','Ты обожаешь','Она обожает','Мы обожаем','Они обожают']},
 {id:'saber', rule:'saber_conhecer', skill:true,
  aux:['sei','sabes','sabe','sabemos','sabem'],
  ru:['Я умею','Ты умеешь','Она умеет','Мы умеем','Они умеют']},
 {id:'tentar', rule:null, needCont:true,
  aux:['tento','tentas','tenta','tentamos','tentam'],
  ru:['Я пытаюсь','Ты пытаешься','Она пытается','Мы пытаемся','Они пытаются']},
 {id:'vir', rule:null, needCont:true,
  aux:['venho','vens','vem','vimos','vêm'],
  ru:['Я прихожу','Ты приходишь','Она приходит','Мы приходим','Они приходят']},
 {id:'ficar a', rule:null, needCont:true,
  aux:['fico a','ficas a','fica a','ficamos a','ficam a'],
  ru:['Я остаюсь','Ты остаёшься','Она остаётся','Мы остаёмся','Они остаются']},
 {id:'aprender a', rule:null, needCont:true,
  aux:['aprendo a','aprendes a','aprende a','aprendemos a','aprendem a'],
  ru:['Я учусь','Ты учишься','Она учится','Мы учимся','Они учатся']},
 ...
 {id:'é melhor', rule:'precisar_dever', persons:[2], impersonalRu:true,
  aux:['é melhor','é melhor','é melhor','é melhor','é melhor'],
  ru:['Лучше','Лучше','Лучше','Лучше','Лучше']},
];
const SKILL_VERBS = new Set(['falar','ler','escrever','fazer','cozinhar','nadar','jogar','dançar']);
function infFor(v, p){
...
function startVerbDay(drill){
  ...
  SES = {queue: shuffle(steps).map(s=>{ const q = ({
