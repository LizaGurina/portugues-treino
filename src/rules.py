...
("e_que", 1, "Вопросы с é que",
 "В разговорных вопросах после вопросительного слова почти всегда вставляется <b>é que</b> — "
 "это не переводится и не меняет смысл, но звучит естественно:<br>"
 "<i>Onde moras?</i> → <b>Onde é que moras?</b><br>"
 "После é que порядок слов прямой (подлежащее перед глаголом).",
 [("Como é que te chamas?", "Как тебя зовут?"),
  ("Onde é que vocês moram?", "Где вы живёте?"),
  ("Porque é que não vens connosco?", "Почему ты не идёшь с нами?"),
  ("A que horas é que começa a aula?", "Во сколько начинается урок?")]),
]